...
public class SplitingStrings {
	...
	public static void main(String[] args) {
		...
		String s31="hari, aditya, yadav, naveeN";
		...
		/**
		 * 1. public String[] split(String delim)
		 * 2. Its parameter is regex.
		 ...
		 *   
		 * 4. If the given argument string does not have any special meaning 
		 * the current string will be split by the given character itself.
		 * 		Ex: "a", string is split by the letter "a"
		 * 
		 * 5. If given argument string is completely equal to current 
		 * string then empty array will be return with 0 tokens.
		 * 
		 * 6. If given argument is not matched with any character in current 
		 * string, current string will be return as one token.
		 * 
		 * 7. for the given argument string LRFT token is not found but 
		 * RIGHT tokens found, as LEFt token it includes an empty string.
		 * 
		 * 8. If we pass empty string "" as delimeter  each character
		 * will be return as a token
		 * 
 ...
 * RIGHT tokens found, as LEFt token it includes an empty string.
 * 
 * 8. If we pass empty string "" as delimiter  each character
 * will be return as a token
 * 
 * 9. Available from JDK 1.4
 * 
